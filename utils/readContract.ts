...
export const erc721Address = "0x0483b0dfc6c78062b9e999a82ffb795925381415";

export const ownerOf = async (tokenId: BigInt) => {
...
export const tokenURI = async (tokenId: BigInt) => {
...
async function main() {
  ...
  console.log(owner);
  const uri = await tokenURI(BigInt(tokenId));
  console.log(uri);
}
main();
